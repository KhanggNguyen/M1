...
namespace Hotel.App_Code
{
    public class ProgrammeTest
    {
        static void Main(string[] args)
        {
            ...
            Chambre vC1 = new Chambre(2, 200, vatel, "../Images/vC1.jpg");
            Chambre vC2 = new Chambre(2, 200, vatel, "../Images/vC1.jpg");
            ...
            Chambre pC1 = new Chambre(2, 250, pullman, "../Images/vC1.jpg");
            Chambre pC2 = new Chambre(2, 250, pullman, "../Images/vC1.jpg");

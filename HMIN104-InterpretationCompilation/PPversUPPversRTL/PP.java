...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr UPParr = arr.toUPP(locals);
        UPPExpr UPPindex = index.toUPP(locals);
        return new UPPLoad(new UPPAdd(UPParr, new UPPMul(UPPindex,new UPPCte(4))));
    }//toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        UPPExpr nval = val.toUPP(locals);
        return new ArrayStore(new UPPAdd(narr, new UPPMul(nindex, new UPPCte(4))),nval);
    }//toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP () {
        ...
        ncode = code.toUPP(nall);
        return UPPProc(nname, nargs, nlocal, ncode);
    }//toUPP

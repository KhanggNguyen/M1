...
class UPPTrue extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        return new RTLTrue(RLTCte, "1", succ); 
    }//toRTL
...
class UPPFalse extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        return new RTLTrue(RLTCte, "0", succ); 
    }//toRTL
...
class UPPGVar extends UPPExpr {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        return RTLGetGVar(reg, name, succ);
    }//toRTL
...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister ne = e.getPRegister(locals);
        return new RTLXOri(ne,reg,succ);
    }//toRTL
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        RTLEq eq = new RTLEq(regCond, i1, i2);
        RTLInst ncond = cond.toRTL(locals,globals,regCond,eq);

public class SortedDictionary extends OrderedDictionary {
	...
	int newIndexOf(Object key) {
		//la clŽ doit tre un ŽlŽment de type comparable mais impossible de changer la signature de la mŽthode
		Comparable cKey = (Comparable) key;
		//crŽation de nouveaux tableaux plus grands de 1
		Object[] newKeys = new Object[keys.length + 1];
		Object[] newValues = new Object[keys.length + 1];
		int i = 0, ret = 0;
		//recherche de la position de la dernire clŽ plus petite que ckey

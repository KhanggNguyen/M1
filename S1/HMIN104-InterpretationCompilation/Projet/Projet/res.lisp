((JMP (LABEL ENDFIBO)) (LABEL FIBO) (MOVE FP R0) (SUB (LIT 1) R0) (LOAD R0 R0)
 ...
 (CMP R0 R1) (MOVE (LIT 1) R0) (JEQ (LABEL FINCOMP1)) (MOVE (LIT 0) R0)
 (LABEL FINCOMP1) (POP R1) (POP R2) (MOVE R1 FP) (MOVE R2 SP) (CMP (LIT 0) R0)
 (JEQ (LABEL SINON1)) (MOVE (LIT 0) R0) (JMP (LABEL FINSI1)) (LABEL SINON1)
 ...
 (MOVE (LIT 1) R0) (JEQ (LABEL FINCOMP2)) (MOVE (LIT 0) R0) (LABEL FINCOMP2)
 (POP R1) (POP R2) (MOVE R1 FP) (MOVE R2 SP) (CMP (LIT 0) R0)
 (JEQ (LABEL SINON2)) (MOVE (LIT 1) R0) (JMP (LABEL FINSI2)) (LABEL SINON2)
 ...
 (MOVE R2 SP) (LABEL FINSI2) (LABEL FINSI1) (MOVE FP R1) (ADD (LIT 4) R1)
 (MOVE R1 SP) (RTN) (LABEL ENDFIBO) (MOVE (LIT 7) R0) (PUSH R0) (MOVE FP R1)

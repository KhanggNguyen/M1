...
// Si le nombre n'est pas premiers stock les facteurs dans a et b et renvoi vrai
// sinon renvoie faux et ne stock rien dans a et b.
...
int main(int argc, char const *argv[]) {
    ...
    PRINT_USAGE_IF(argc < 3, "Usage %s <NUM> <THREAD_NUM>\n", argv[0]);
